package com.dreamofninjas.battler.levels
{
	...
	public class LevelOverworld extends LevelModel {

		public static const MAP_FILE:String = "overworld.tmx";
		
		public static function Loader(playerModel:PlayerModel):LevelLoader {
			return new LevelLoader(MAP_FILE, LevelOverworld, playerModel);
		}
		...
		public function LevelOverworld(playerModel:PlayerModel, mapModel:MapModel, typeMap:Dictionary, spawns:Vector.<UnitSpawnInfo>) {
